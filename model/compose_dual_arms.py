...
left_arm_mount = model.worldbody.add(
    "site", name="left_arm_mount", pos=(X_POS, ARM_SPACING / 2.0, 0.0)
)
right_arm_mount = model.worldbody.add(
    "site", name="right_arm_mount", pos=(X_POS, -ARM_SPACING / 2.0, 0.0)
)
